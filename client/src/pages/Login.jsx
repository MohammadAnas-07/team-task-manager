    ...
    <div className="min-h-screen bg-apple-surface-black flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-[28px] font-semibold text-apple-on-dark tracking-tight leading-tight">Welcome back</h1>
          <p className="text-[17px] text-apple-body-muted mt-2 tracking-[-0.374px]">Sign in to your account</p>
        </div>
        ...
        <div className="bg-apple-surface-tile-1 border border-apple-surface-tile-2 rounded-[24px] p-8 shadow-product">
          ...
          <p className="text-center text-[14px] text-apple-body-muted mt-8 tracking-[-0.224px]">
            ...
            <Link to="/signup" className="text-apple-primary hover:text-apple-primary-on-dark font-medium transition-colors">
              Create one
            </Link>
          </p>
        </div>
